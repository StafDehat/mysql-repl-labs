...
# Run a query that will get replicated, but shouldn't
mysql employees -e "UPDATE classicmodels.employees SET lastName = 'Murphy-Williams' where employeeNumber = '1002';"
